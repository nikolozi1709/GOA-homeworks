#1 ჩვენ ვისწავლეთ Comparison Operators შედარებითი ოპერატორები >,< == შედარების ოპერატორი გამოიყენება ორი მნიშვნელობის ერთმანეთთან შესადარებლად რათა გავიგოთ რომელი რომელზე დიდი ან პატარაა
